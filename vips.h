...
int vips_rotate_bimg(VipsImage *in, VipsImage **out, int angle)
{
...
int vips_pngsave_bridge(VipsImage *in, void **buf, size_t *len, int strip, int compression, int quality, int interlace)
{
